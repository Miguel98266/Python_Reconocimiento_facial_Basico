...
while True:
    ...
    if imagen_A6 is not None:
        ...
        contorno2 = cv2.findContours(
            umbral2, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE
        )[0]
        ...
        for c_2 in contorno2:
            ...
            if area < 11000 and area > 10000:
                font = cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "5 Pesos", (x, y), font, 0.75, (0, 255, 0), 2)
                suma1 = suma1 + 5

            if area < 13000 and area > 12000:
                font = cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "10 pesos", (x, y), font, 0.75, (0, 255, 0), 2)
                suma2 = suma2 + 10
        total = suma1 + suma2
